...
<div>
                    ...
                    <div class="card-body row">
                      <div class="row justify-content-evenly lista-emprendimientos">
                        ...
                        <div class="col-lg-6 col-sm-12 margin-responsive-categorias">
                            ...
                            <div class="col-lg-5 col-sm-12 margin-responsive-categorias">
 ...
 <footer class="margin-footer">
      ...
      <div class=baseDerechos>
        <div>Copyright © 2021 | Todos los derechos reservados <a href="https://halmateam.000webhostapp.com/">HALMA TEAM</a><span class="modulo-emprendedores-responsive"> | | 
...
export default {
 ...
 created() {
 let apiURL = "https://pure-sands-18700.herokuapp.com/api/listar";
 axios
 .get(apiURL)
 .then((res) => {
