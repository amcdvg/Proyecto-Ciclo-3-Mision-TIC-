                ...
                <nav class="nav-bar navegacion-crud">
                    ...
                    <div class="collapse" id="mi-emprendimiento">
                        <div class="sub-navegacion-crud">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <router-link :to="{ name: 'ver-emprendimiento', params: emprendedor._id }" class="perfil-seleccionado perfil nav-link active" aria-current="page" href="#">Ver Mi Emprendimiento</router-link>
                                </li>
                                <li class="nav-item">
