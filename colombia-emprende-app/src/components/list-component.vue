...
<div>
 ...
 <div class="row">
 <div class="col-md-12">
 <div v-for="emprendimiento in Emprendedores" :key="emprendimiento._id" class="tienda card mb-3 w-100 m-2 p-2 col">
        <div class="row">
                <div class="col-10">
                    <div class="card-body row">
                        <h5 class="card-title">{{emprendimiento.emprendimientoName}}</h5>
                            <p class="card-text">{{emprendimiento.emprendimientoEmail}}</p>
                            <p> {{emprendimiento.emprendimientoDireccion}}</p>
                           <p> {{emprendimiento.emprendimientoCiudad}}</p>
                        </div>
                    </div>  
                </div>
 </div>
