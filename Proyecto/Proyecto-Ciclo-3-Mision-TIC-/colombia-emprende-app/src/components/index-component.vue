...
<div>
 ...
 <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <main class="fondo-claro">
       ...
       <carousel-3d :controls-visible="true" :clickable="false" :autoplay="true" :autoplayTimeout="3500" :autoplayHoverPause="true" :perspective="0">
          <slide class="gallery-item imagen-categorias" v-for="(slide, i) in slides" :key="i" :index="i">
            <div class="row" v-html="slide.template">
            </div>
        ...
        <div class="row m-3 justify-content-center p-3">
            ...
            <div class="seccion-noticias card col-3 p-3">
                ...
                <div class="card-footer text-center">
                    <a href="https://dapre.presidencia.gov.co/normativa/normativa/LEY%202069%20DEL%2031%20DE%20DICIEMBRE%20DE%202020.pdf" target="_blank">
                    Ver Documento
                    </a>
                </div>
            </div>
        ...
        <div class="related-pages-fondo p-3">
    ...
    export default {
       ...
       `},
        ...
        {template:`
                            ...
                            <div class="texto-categorias card-img-overlay">
                            <a href="/emprendimientos/categorias/Niños y Bebes">Niños y <br> Bebes</a>
                            </div>
